  ...
  public static void main(String[] argv) throws Exception {
    ...
    private static String randomsentence(int n) {
        if(n==0){
          ...
          return "Lost my time, my life is going on";
        }
       else if(n==4){
          return "If I'm losing now, but I'm winning later";
        }
        else {
          return "I will be so strong, looking for a new version of myself";
        }
    }
}
